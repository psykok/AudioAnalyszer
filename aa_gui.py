...
class fMain ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText4 = wx.StaticText( self.m_toolBar2, wx.ID_ANY, u"Instrument", wx.DefaultPosition, wx.Size( 80,-1 ), 0 )
		...
		self.m_staticText2 = wx.StaticText( self.m_toolBar2, wx.ID_ANY, u"GPIB Address", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		sbSizer2.Add( self.txtMeasTitle, 1, wx.ALL, 5 )


		bSizer61.Add( sbSizer2, 1, wx.EXPAND, 5 )
		...
		sbSizer1.Add( self.comboBMeasType, 0, wx.ALL, 5 )


		bSizer61.Add( sbSizer1, 1, wx.EXPAND, 5 )
		...
		sbSizer6.Add( self.comboBMeasUnits, 0, wx.ALL, 5 )


		bSizer61.Add( sbSizer6, 1, wx.EXPAND, 5 )
		...
		self.m_spinCtrl3 = wx.SpinCtrl( sizerFreqSweep.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_RIGHT|wx.SP_ARROW_KEYS, 50, 100000, 19999 )
		...
		self.m_spinCtrl4 = wx.SpinCtrl( sizerFreqSweep.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 120,-1 ), wx.ALIGN_RIGHT|wx.SP_ARROW_KEYS, 1, 50, 11 )
		...
		self.m_spinCtrl5 = wx.SpinCtrl( sizerFreq.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_RIGHT|wx.SP_ARROW_KEYS, 100, 150000, 1001 )
		...
		self.m_spinCtrlDouble1 = wx.SpinCtrlDouble( sizerVoltSweep.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_RIGHT|wx.SP_ARROW_KEYS, 0.1, 10, 0.1, 0.1 )
		...
		self.m_spinCtrlDouble2 = wx.SpinCtrlDouble( sizerVoltSweep.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_RIGHT|wx.SP_ARROW_KEYS, 0.1, 10, 1, 1 )
		...
		self.m_spinCtrl6 = wx.SpinCtrl( sizerVoltSweep.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 120,-1 ), wx.ALIGN_RIGHT|wx.SP_ARROW_KEYS, 1, 50, 9 )
		...
		self.m_toolBar21 = wx.ToolBar( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TB_HORIZONTAL )
		self.lOUtput1 = wx.StaticText( self.m_toolBar21, wx.ID_ANY, u"THD (%)", wx.DefaultPosition, wx.Size( 100,-1 ), 0 )
		self.lOUtput1.Wrap( -1 )

		self.m_toolBar21.AddControl( self.lOUtput1 )
		self.tOutput1 = wx.TextCtrl( self.m_toolBar21, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 100,-1 ), wx.TE_READONLY )
		self.m_toolBar21.AddControl( self.tOutput1 )
		self.m_toolBar21.AddSeparator()

		self.lOutput2 = wx.StaticText( self.m_toolBar21, wx.ID_ANY, u"Freq(Hz)", wx.DefaultPosition, wx.Size( 100,-1 ), 0 )
		self.lOutput2.Wrap( -1 )

		self.m_toolBar21.AddControl( self.lOutput2 )
		self.tOutput2 = wx.TextCtrl( self.m_toolBar21, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 100,-1 ), wx.TE_READONLY )
		...
		bSizer161.Add( self.panelPlot, 0, wx.EXPAND |wx.ALL, 5 )
		...
		self.btStart.Bind( wx.EVT_BUTTON, self.btStartClick )
		self.btClear.Bind( wx.EVT_BUTTON, self.btClearClick )
